...
- [v14: Lo que hay debajo de la vía (2) (Claude)](./verificacion_inseguridad_autor_v14.md) — el mapa es lineal y el estado de la máquina está acotado por una constante (`PathNodeId` guarda un nivel de historia): la abstracción exponencial funciona. Y por eso **"sin zombis", junto con una cota de tiempo, es P = NP**. Mediciones reproducibles con `lake exe width`.
