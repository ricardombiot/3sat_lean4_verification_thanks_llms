...
**SHOULD TARGET:**  
Migrar y verificar las funciones build, to_png del archivo `docs/original_julia/src/graph_map/graph_map_visual.jl` a Lean 4.
...
**SCOPE:**  
Esta microtarea cubre exclusivamente la migración y verificación de las funciones build, to_png del archivo `docs/original_julia/src/graph_map/graph_map_visual.jl`.
