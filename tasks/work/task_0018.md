...
**SHOULD TARGET:**  
Migrar y verificar las funciones new, for_each del archivo `docs/original_julia/src/db/path/cols/path_col_nodes.jl` a Lean 4.
...
**ACCEPTANCE CRITERIA:**  
1. 1. Las funciones new, for_each están implementadas en Lean 4 y su comportamiento coincide con el de Julia.
...
**SCOPE:**  
Esta microtarea cubre exclusivamente la migración y verificación de las funciones new, for_each del archivo `docs/original_julia/src/db/path/cols/path_col_nodes.jl`.
