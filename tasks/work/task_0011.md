...
**SHOULD TARGET:**  
Migrar y verificar las funciones new, clean_title del archivo `docs/original_julia/src/db/map/cols/map_col_vars.jl` a Lean 4.

**SHOULD DO:**  
1. Analizar el código Julia de las funciones:
- `new` (línea 8)
- `clean_title` (línea 18)
...
**ACCEPTANCE CRITERIA:**  
1. 1. Las funciones new, clean_title están implementadas en Lean 4 y su comportamiento coincide con el de Julia.
...
**SCOPE:**  
Esta microtarea cubre exclusivamente la migración y verificación de las funciones new, clean_title del archivo `docs/original_julia/src/db/map/cols/map_col_vars.jl`.
