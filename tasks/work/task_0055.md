...
**SHOULD TARGET:**  
Migrar y verificar las funciones new, is_finished del archivo `docs/original_julia/src/sat_machine/sat_machine_pow.jl` a Lean 4.

**SHOULD DO:**  
1. Analizar el código Julia de las funciones:
- `new` (línea 25)
- `is_finished` (línea 66)
...
**ACCEPTANCE CRITERIA:**  
1. 1. Las funciones new, is_finished están implementadas en Lean 4 y su comportamiento coincide con el de Julia.
...
**SCOPE:**  
Esta microtarea cubre exclusivamente la migración y verificación de las funciones new, is_finished del archivo `docs/original_julia/src/sat_machine/sat_machine_pow.jl`.
