...
**SHOULD TARGET:**  
Migrar y verificar las funciones new del archivo `docs/original_julia/src/graph_path/reader/path_exp_reader.jl` a Lean 4.
...
**RESOURCES:**  
- `docs/original_julia/src/docs/original_julia/src/graph_path/reader/path_exp_reader.jl`
...
**SCOPE:**  
Esta microtarea cubre exclusivamente la migración y verificación de las funciones new del archivo `docs/original_julia/src/graph_path/reader/path_exp_reader.jl`.
