...
**SHOULD TARGET:**  
Migrar y verificar las funciones is_neg, get_step_var del archivo `docs/original_julia/src/db/map/cols/map_col_vars.jl` a Lean 4.

**SHOULD DO:**  
1. Analizar el código Julia de las funciones:
- `is_neg` (línea 24)
- `get_step_var` (línea 28)
...
**ACCEPTANCE CRITERIA:**  
1. 1. Las funciones is_neg, get_step_var están implementadas en Lean 4 y su comportamiento coincide con el de Julia.
...
**RESOURCES:**  
- `docs/original_julia/src/docs/original_julia/src/db/map/cols/map_col_vars.jl`
...
**SCOPE:**  
Esta microtarea cubre exclusivamente la migración y verificación de las funciones is_neg, get_step_var del archivo `docs/original_julia/src/db/map/cols/map_col_vars.jl`.
