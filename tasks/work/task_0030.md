...
**SHOULD TARGET:**  
Migrar y verificar las funciones draw_owners, get_key_node del archivo `docs/original_julia/src/graph_map/graph_map_visual.jl` a Lean 4.

**SHOULD DO:**  
1. Analizar el código Julia de las funciones:
- `draw_owners` (línea 98)
- `get_key_node` (línea 132)
...
**RESOURCES:**  
- `docs/original_julia/src/docs/original_julia/src/graph_map/graph_map_visual.jl`
...
**SCOPE:**  
Esta microtarea cubre exclusivamente la migración y verificación de las funciones draw_owners, get_key_node del archivo `docs/original_julia/src/graph_map/graph_map_visual.jl`.
