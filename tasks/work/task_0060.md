...
**SHOULD TARGET:**  
Migrar y verificar las funciones to_string, to_string del archivo `docs/original_julia/src/utils/alias.jl` a Lean 4.
...
**ACCEPTANCE CRITERIA:**  
1. 1. Las funciones to_string, to_string están implementadas en Lean 4 y su comportamiento coincide con el de Julia.
...
**SCOPE:**  
Esta microtarea cubre exclusivamente la migración y verificación de las funciones to_string, to_string del archivo `docs/original_julia/src/utils/alias.jl`.
