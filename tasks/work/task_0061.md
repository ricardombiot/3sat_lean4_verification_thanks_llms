...
**SHOULD TARGET:**  
Migrar y verificar las funciones test_all, test del archivo `docs/original_julia/src/utils/checker.jl` a Lean 4.
...
**ACCEPTANCE CRITERIA:**  
1. 1. Las funciones test_all, test están implementadas en Lean 4 y su comportamiento coincide con el de Julia.
...
**RESOURCES:**  
- `docs/original_julia/src/docs/original_julia/src/utils/checker.jl`
...
**SCOPE:**  
Esta microtarea cubre exclusivamente la migración y verificación de las funciones test_all, test del archivo `docs/original_julia/src/utils/checker.jl`.
