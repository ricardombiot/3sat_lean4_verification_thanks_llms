...
**SHOULD TARGET:**  
Migrar y verificar las funciones get_value del archivo `docs/original_julia/src/utils/checker.jl` a Lean 4.
...
**SCOPE:**  
Esta microtarea cubre exclusivamente la migración y verificación de las funciones get_value del archivo `docs/original_julia/src/utils/checker.jl`.
