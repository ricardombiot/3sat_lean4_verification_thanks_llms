...
**SHOULD TARGET:**  
Migrar y verificar las funciones build, to_png del archivo `docs/original_julia/src/graph_path/graph_path_visual.jl` a Lean 4.
...
**ACCEPTANCE CRITERIA:**  
1. 1. Las funciones build, to_png están implementadas en Lean 4 y su comportamiento coincide con el de Julia.
...
**SCOPE:**  
Esta microtarea cubre exclusivamente la migración y verificación de las funciones build, to_png del archivo `docs/original_julia/src/graph_path/graph_path_visual.jl`.
