...
**SHOULD TARGET:**  
Migrar y verificar las funciones get_node_parents_owners, get_node_sons_owners del archivo `docs/original_julia/src/graph_pow/graph_pow_abstract_node.jl` a Lean 4.

**SHOULD DO:**  
1. Analizar el código Julia de las funciones:
- `get_node_parents_owners` (línea 46)
- `get_node_sons_owners` (línea 66)
...
**ACCEPTANCE CRITERIA:**  
1. 1. Las funciones get_node_parents_owners, get_node_sons_owners están implementadas en Lean 4 y su comportamiento coincide con el de Julia.
...
**RESOURCES:**  
- `docs/original_julia/src/docs/original_julia/src/graph_pow/graph_pow_abstract_node.jl`
...
**SCOPE:**  
Esta microtarea cubre exclusivamente la migración y verificación de las funciones get_node_parents_owners, get_node_sons_owners del archivo `docs/original_julia/src/graph_pow/graph_pow_abstract_node.jl`.
