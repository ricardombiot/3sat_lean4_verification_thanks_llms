-- lean/improves_bin/AbsSatBin/GraphPath/Model/MapChain.lean
...
namespace AbsSatBin.GraphPath.Model.MapChain
...
/-- info: 'AbsSatBin.GraphPath.Model.MapChain.reqSatisfying_of_pairwiseOwned' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms reqSatisfying_of_pairwiseOwned

/-- info: 'AbsSatBin.GraphPath.Model.MapChain.ChainSound_of_parts' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
...
/-- info: 'AbsSatBin.GraphPath.Model.MapChain.owner_at_req_shares_mapid' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms owner_at_req_shares_mapid

end AbsSatBin.GraphPath.Model.MapChain
