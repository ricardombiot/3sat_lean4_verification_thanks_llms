-- lean/improves_bin/AbsSatBin/GraphPath/Model/PickInduction.lean
...
namespace AbsSatBin.GraphPath.Model.PickInduction
...
theorem reviewPass_eq (g : GPathM) :
    reviewPass g = reviewSons (reviewParents (cleanPair g)) := rfl
...
theorem Inhabited_of_filterAll (g : GPathM) (hnd : NodupIds g) (reqs : List NodeId)
    (h : AbsSatBin.GraphPath.Model.Inhabited (filterAll g reqs)) :
...
/-- info: 'AbsSatBin.GraphPath.Model.PickInduction.Inhabited_of_pickSome' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
...
/-- info: 'AbsSatBin.GraphPath.Model.PickInduction.measure_filterAll_lt' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms measure_filterAll_lt

/-- info: 'AbsSatBin.GraphPath.Model.PickInduction.isValid_filterRequire' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms isValid_filterRequire

/-- info: 'AbsSatBin.GraphPath.Model.PickInduction.isValid_review_of_pass' does not depend on any axioms -/
#guard_msgs in
#print axioms isValid_review_of_pass

/-- info: 'AbsSatBin.GraphPath.Model.PickInduction.isValid_removeNode_of_other' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms isValid_removeNode_of_other

/-- info: 'AbsSatBin.GraphPath.Model.PickInduction.Inhabited_of_pickValid' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms Inhabited_of_pickValid

end AbsSatBin.GraphPath.Model.PickInduction
