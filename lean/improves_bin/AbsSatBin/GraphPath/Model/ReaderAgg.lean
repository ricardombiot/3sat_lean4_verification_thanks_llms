-- lean/improves_bin/AbsSatBin/GraphPath/Model/ReaderAgg.lean
...
namespace AbsSatBin.GraphPath.Model.ReaderAgg
...
open AbsSatBin.GraphPath.Model.PickInduction (choiceAt hasChoice NoChoice measure_filterRequire_lt
  measure_review_le)
...
/-- info: 'AbsSatBin.GraphPath.Model.ReaderAgg.readable_of_readableAgg' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms readable_of_readableAgg

/-- info: 'AbsSatBin.GraphPath.Model.ReaderAgg.Inhabited_of_pickSomeAgg' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms Inhabited_of_pickSomeAgg

end AbsSatBin.GraphPath.Model.ReaderAgg
