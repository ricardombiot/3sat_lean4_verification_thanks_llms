-- lean/improves_bin/AbsSatBin/GraphPath/Model/Ownership.lean
...
namespace AbsSatBin.GraphPath.Model.Ownership
...
/-- info: 'AbsSatBin.GraphPath.Model.Ownership.SupportClique_gives_PairwiseOwned' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms SupportClique_gives_PairwiseOwned

/-- info: 'AbsSatBin.GraphPath.Model.Ownership.self_owned_of_SelfOwned' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms self_owned_of_SelfOwned

end AbsSatBin.GraphPath.Model.Ownership
