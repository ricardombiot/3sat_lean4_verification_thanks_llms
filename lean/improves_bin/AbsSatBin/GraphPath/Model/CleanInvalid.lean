-- lean/improves_bin/AbsSatBin/GraphPath/Model/CleanInvalid.lean
...
/-- info: 'AbsSatBin.GraphPath.Model.ChainSound_cleanInvalid' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms ChainSound_cleanInvalid

/-- info: 'AbsSatBin.GraphPath.Model.ChainSound_cleanStep' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
...
/-- info: 'AbsSatBin.GraphPath.Model.ChainSound_cleanPair' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
