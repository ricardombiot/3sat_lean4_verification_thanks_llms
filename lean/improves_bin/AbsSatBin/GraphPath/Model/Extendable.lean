-- lean/improves_bin/AbsSatBin/GraphPath/Model/Extendable.lean
...
namespace AbsSatBin.GraphPath.Model.Extendable

open AbsSatBin.Utils.Alias
open AbsSatBin.GraphPath.Model
open AbsSatBin.GraphPath.Model.GPathM
open AbsSatBin.GraphPath.Model.Verdict (SupportedAt)
...
/-- info: 'AbsSatBin.GraphPath.Model.Extendable.Supported_of_Extend' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
...
def GoodParentOnCliques (g : GPathM) : Prop :=
  ∀ (p : PathNodeId) (n : PNodeM), g.node? p = some n → 0 < p.id.step →
    ∀ S : PathNodeId → Prop,
      ...
      Coherent g S →
      ∃ c ∈ n.parents, c.id.step = p.id.step - 1 ∧  -- idx: a parent sits one row below (gpath rows = map steps)
...
/-- info: 'AbsSatBin.GraphPath.Model.Extendable.ExtendDownTop_of_GoodParentOnCliques' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
...
/-- info: 'AbsSatBin.GraphPath.Model.Extendable.good_of_pairwise_two' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms good_of_pairwise_two

end AbsSatBin.GraphPath.Model.Extendable
