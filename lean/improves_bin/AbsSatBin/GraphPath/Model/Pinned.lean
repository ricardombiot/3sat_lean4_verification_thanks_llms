-- lean/improves_bin/AbsSatBin/GraphPath/Model/Pinned.lean
...
namespace AbsSatBin.GraphPath.Model.Pinned
...
theorem ctx_filterAll (g : GPathM) (reqs : List NodeId) (hreach : Reachable reqOf forb g)
    (hv : isValid (filterAll g reqs) = true) : Ctx (filterAll g reqs) where
  self := SelfOwn.SelfOwned_filterAll reqOf forb g reqs hreach hv
  gn := GownersNodes.GN_filterAll g reqs (GownersNodes.GN_reachable reqOf forb g hreach)
  shape := Parents.Shape_filterAll reqOf forb g reqs hreach
  rootz := Sons.RootAtZero_reachable_filterAll reqOf forb g reqs hreach
  pmp := ParentId.PMP_filterAll reqOf forb g reqs hreach
  gpmp := ParentId.GPMP_filterAll reqOf forb g reqs hreach
...
theorem inhabited_of_covered (g : GPathM) (reqs : List NodeId) (hreach : Reachable reqOf forb g)
  ...
  obtain ⟨sel, hchain⟩ := PathExists.exists_isChain reqOf forb g reqs hreach hv hpos
  exact ⟨pathOf sel (filterAll g reqs), sel, hchain,
    pairwiseOwned_of_fullyPinned _ (ctx_filterAll reqOf forb g reqs hreach hv)
      (fullyPinned_filterAll g reqs hcov) sel hchain, rfl⟩

/-- info: 'AbsSatBin.GraphPath.Model.Pinned.inhabited_of_covered' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
...
theorem inhabited_of_noChoice_filterAll (g : GPathM) (reqs : List NodeId)
  ...
  inhabited_of_noChoice _ (ctx_filterAll reqOf forb g reqs hreach hv) hnc
    (PathExists.exists_isChain reqOf forb g reqs hreach hv hpos)

/-- info: 'AbsSatBin.GraphPath.Model.Pinned.inhabited_of_noChoice_filterAll' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
...
/-- info: 'AbsSatBin.GraphPath.Model.Pinned.pairwiseOwned_of_fullyPinned' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms pairwiseOwned_of_fullyPinned

/-- info: 'AbsSatBin.GraphPath.Model.Pinned.pid_unique' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms pid_unique

end AbsSatBin.GraphPath.Model.Pinned
