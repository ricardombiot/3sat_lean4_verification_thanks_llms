-- lean/improves_bin/AbsSatBin/GraphPath/Model/Coherence.lean
...
/-- info: 'AbsSatBin.GraphPath.Model.ChainSound_reviewPass' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms ChainSound_reviewPass

/-- info: 'AbsSatBin.GraphPath.Model.SupportedS_review' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
