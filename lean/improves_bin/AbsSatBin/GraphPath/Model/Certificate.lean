-- lean/improves_bin/AbsSatBin/GraphPath/Model/Certificate.lean
...
namespace AbsSatBin.GraphPath.Model.Certificate
...
theorem Inhabited_of_isCert (g : GPathM) (sel : List PathNodeId)
    (h : isCert g sel = true) : AbsSatBin.GraphPath.Model.Inhabited g :=
...
/-- info: 'AbsSatBin.GraphPath.Model.Certificate.isCert_sound' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms isCert_sound

/-- info: 'AbsSatBin.GraphPath.Model.Certificate.Supported_of_checkSupported' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms Supported_of_checkSupported

/-- info: 'AbsSatBin.GraphPath.Model.Certificate.Inhabited_of_isCert' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms Inhabited_of_isCert

end AbsSatBin.GraphPath.Model.Certificate
