-- lean/improves_bin/AbsSatBin/GraphPath/Model/Join.lean
...
/-- info: 'AbsSatBin.GraphPath.Model.denot_join_union' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms denot_join_union

/-- info: 'AbsSatBin.GraphPath.Model.Supported_join' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
