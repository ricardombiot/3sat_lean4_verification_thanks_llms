-- lean/improves_bin/AbsSatBin/GraphPath/Model/Verdict.lean
...
namespace AbsSatBin.GraphPath.Model.Verdict
...
theorem Inhabited_of_SupportedAt (g : GPathM) (pid : PathNodeId)
    (h : SupportedAt g pid) : AbsSatBin.GraphPath.Model.Inhabited g := by
...
theorem Inhabited_iff_SupportedAt (g : GPathM) (hpos : 0 < g.current_step) :
    AbsSatBin.GraphPath.Model.Inhabited g ↔ ∃ pid, (g.node? pid).isSome ∧ SupportedAt g pid :=
...
/-- info: 'AbsSatBin.GraphPath.Model.Verdict.Inhabited_iff_SupportedAt' depends on axioms: [propext] -/
#guard_msgs in
#print axioms Inhabited_iff_SupportedAt

/-- info: 'AbsSatBin.GraphPath.Model.Verdict.Supported_iff' does not depend on any axioms -/
#guard_msgs in
#print axioms Supported_iff

/-- info: 'AbsSatBin.GraphPath.Model.Verdict.not_in_denot_of_not_SupportedAt' does not depend on any axioms -/
#guard_msgs in
#print axioms not_in_denot_of_not_SupportedAt

end AbsSatBin.GraphPath.Model.Verdict
