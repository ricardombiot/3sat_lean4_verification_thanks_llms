-- lean/improves_bin/AbsSatBin/GraphPath/Model/Fuel.lean
...
/-- info: 'AbsSatBin.GraphPath.Model.GPathM.measure_reviewPass_le' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms measure_reviewPass_le

/-- info: 'AbsSatBin.GraphPath.Model.GPathM.review_stable' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms review_stable

/-- info: 'AbsSatBin.GraphPath.Model.GPathM.reviewPass_review' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms reviewPass_review

/-- info: 'AbsSatBin.GraphPath.Model.GPathM.review_idempotent' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms review_idempotent

/-- info: 'AbsSatBin.GraphPath.Model.GPathM.review_node_valid' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms review_node_valid

/-- info: 'AbsSatBin.GraphPath.Model.GPathM.review_owners_within_gowners' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms review_owners_within_gowners

/-- info: 'AbsSatBin.GraphPath.Model.GPathM.review_owners_coherent_parents' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms review_owners_coherent_parents

/-- info: 'AbsSatBin.GraphPath.Model.GPathM.review_owners_coherent_sons' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
