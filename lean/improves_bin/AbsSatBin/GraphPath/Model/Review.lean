-- lean/improves_bin/AbsSatBin/GraphPath/Model/Review.lean
...
/-- info: 'AbsSatBin.GraphPath.Model.isValidNode_of_chain' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms isValidNode_of_chain

/-- info: 'AbsSatBin.GraphPath.Model.mem_intersectOwners_of_mem' depends on axioms: [propext] -/
#guard_msgs in
