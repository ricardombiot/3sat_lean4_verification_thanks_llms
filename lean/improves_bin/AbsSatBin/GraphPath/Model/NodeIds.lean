-- lean/improves_bin/AbsSatBin/GraphPath/Model/NodeIds.lean
...
namespace AbsSatBin.GraphPath.Model.NodeIds
...
/-- **The review never duplicates an id either** — the bin UP reviews after a skipped window. -/
theorem NodupIds_review (g : GPathM) (h : NodupIds g) : NodupIds (review g) :=
  List.Sublist.nodup (ids_review g) h

/-- info: 'AbsSatBin.GraphPath.Model.NodeIds.NodupIds_filterAll' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms NodupIds_filterAll

end AbsSatBin.GraphPath.Model.NodeIds
