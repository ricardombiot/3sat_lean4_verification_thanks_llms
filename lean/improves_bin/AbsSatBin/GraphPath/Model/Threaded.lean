-- lean/improves_bin/AbsSatBin/GraphPath/Model/Threaded.lean
...
namespace AbsSatBin.GraphPath.Model.Threaded

open AbsSatBin.Utils.Alias
open AbsSatBin.GraphPath.Model
open AbsSatBin.GraphPath.Model.GPathM
open AbsSatBin.GraphPath.Model.Extendable (PartialChain upd upd_self upd_other isChain_of_partial)
...
/-- info: 'AbsSatBin.GraphPath.Model.Threaded.owners_subset_of_unique_parent' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
...
/-- info: 'AbsSatBin.GraphPath.Model.Threaded.threaded_below' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
...
theorem tctx_filterAll (g : GPathM) (reqs : List NodeId) (hreach : Reachable reqOf forb g)
    (hv : isValid (filterAll g reqs) = true) : TCtx (filterAll g reqs) where
  nodeval := fun pid n hn => review_node_valid _ hv pid n hn
  shape := Parents.Shape_filterAll reqOf forb g reqs hreach
  links := Bridge.linksInOwners_filterAll g reqs hv
  cpar := (Certifies.arcConsistent_filterAll reqOf forb g reqs hreach hv).coherent_parents
  cson := (Certifies.arcConsistent_filterAll reqOf forb g reqs hreach hv).coherent_sons
  sabove := Sons.SAbove_reachable_filterAll reqOf forb g reqs hreach
  sn := Sons.SN_reachable_filterAll reqOf forb g reqs hreach
  pms := Sons.PMS_reachable_filterAll reqOf forb g reqs hreach
  ownerNode := fun pid n hn q hq hlo hhi =>
    Candidates.owner_is_node _ hv
      (GownersNodes.GN_filterAll g reqs (GownersNodes.GN_reachable reqOf forb g hreach))
...
theorem threaded_below_filterAll (g : GPathM) (reqs : List NodeId)
  ...
  threaded_below _ (tctx_filterAll reqOf forb g reqs hreach hv) a n hn
    (SelfOwn.SelfOwned_filterAll reqOf forb g reqs hreach hv a n hn) halo hahi

/-- info: 'AbsSatBin.GraphPath.Model.Threaded.threaded_below_filterAll' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
...
theorem threaded_filterAll (g : GPathM) (reqs : List NodeId) (hreach : Reachable reqOf forb g)
  ...
  threaded _ (tctx_filterAll reqOf forb g reqs hreach hv) a n hn
    (SelfOwn.SelfOwned_filterAll reqOf forb g reqs hreach hv a n hn) halo hahi

/-- info: 'AbsSatBin.GraphPath.Model.Threaded.threaded_filterAll' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
...
/-- info: 'AbsSatBin.GraphPath.Model.Threaded.chain_through_of_symmetric' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms chain_through_of_symmetric

/-- info: 'AbsSatBin.GraphPath.Model.Threaded.owners_contain_chain' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
...
/-- info: 'AbsSatBin.GraphPath.Model.Threaded.owner_below_on_descent' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms owner_below_on_descent

end AbsSatBin.GraphPath.Model.Threaded
