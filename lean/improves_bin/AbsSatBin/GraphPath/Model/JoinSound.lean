-- lean/improves_bin/AbsSatBin/GraphPath/Model/JoinSound.lean
...
/-- info: 'AbsSatBin.GraphPath.Model.SupportedS_join' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms SupportedS_join

/-- info: 'AbsSatBin.GraphPath.Model.ChainSound_of_grown' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
