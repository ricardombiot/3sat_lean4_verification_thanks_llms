-- lean/improves_bin/AbsSatBin/GraphPath/Model/Filter.lean
...
/-- info: 'AbsSatBin.GraphPath.Model.chain_selects_req' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms chain_selects_req

/-- info: 'AbsSatBin.GraphPath.Model.denot_filterRequire' does not depend on any axioms -/
#guard_msgs in
#print axioms denot_filterRequire

/-- info: 'AbsSatBin.GraphPath.Model.denot_review_subset' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms denot_review_subset

/-- info: 'AbsSatBin.GraphPath.Model.denot_filterAll_subset' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
