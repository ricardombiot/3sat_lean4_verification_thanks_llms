-- lean/improves_bin/AbsSatBin/Cnf/Dimacs.lean
...
namespace AbsSatBin.Cnf.Dimacs
...
/-- info: 'AbsSatBin.Cnf.Dimacs.wfB_sound' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms wfB_sound

end AbsSatBin.Cnf.Dimacs
