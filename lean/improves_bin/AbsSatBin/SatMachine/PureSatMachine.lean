...
### For Formal Proofs
Bridge theorems to `PureDriver` live in `AbsSatBin.SatMachine.PureProofs`.
...
namespace AbsSatBin.SatMachine.PureSatMachine
...
end AbsSatBin.SatMachine.PureSatMachine
